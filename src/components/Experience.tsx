...
export default function Experience() {
    ...
    return (
        <div id='experience' className='flex justify-center my-20'>
            <div className='w-3/4 md:w-3/6'>
                <div className='flex w-3/4 flex-col gap-4 '>
                    ...
                    <div className='flex gap-10'>
                        ...
                        <div className={`${select === "autoflow" ? "visible" : "hidden"}`}>
                            <h3>
                                Full Stack Developer <span className='text-[--green] hover-underline-animation'> <a href="https://www.autoflow.com.ar/" target='_blank'>@ Autoflow</a>
                                </span>
                            </h3>
                        ...
                        <div className={`${select === "freelancer" ? "visible" : "hidden"}`}>
                            <h3>
                                Full Stack Developer <span className='text-[--green] hover-underline-animation'>@ Freelancer
                                </span>
                            </h3>
                        ...
                        <div className={`${select === "sml" ? "visible" : "hidden"}`}>
                            <h3>
                                Full Stack Developer <span className='text-[--green] hover-underline-animation'><a href="https://www.socialmedialab.ai/" target="_blank" rel="noopener noreferrer">@ Social Media Lab AI</a>
                                </span>
                            </h3>
