...
export default function About() {
    return (
        <div id='about' className='flex justify-center  gap-10 my-44'>
            <div className='w-3/4 md:w-3/6 flex  justify-center gap-10'>
                <div className='flex w-3/4 flex-col gap-4 '>
                    ...
                    <p className='text-[--light-slate]'>Since then, I've gained experience at two companies: one specializing in <a className='text-[--green] hover-underline-animation' href="https://www.socialmedialab.ai/" target='_blank'>SML</a> applying artificial intelligence to social media and the other in automating processes for car dealerships, called <a className='text-[--green] hover-underline-animation' href="https://www.socialmedialab.ai/" target='_blank'>Autoflow</a>.</p>
                    ...
                    <ul className='grid grid-cols-2 grid-rows-3 gap-4 text-[--light-slate]'>
                        ...
                        <li><span className='text-[--green]'>▹</span> WordPress</li>
                    </ul>
